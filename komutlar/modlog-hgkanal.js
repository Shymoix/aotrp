...
exports.run = async(client, message, args) => {
    ...
    if(!message.member.roles.cache.has('831256637103669274')){
        const embed = new Discord.MessageEmbed()
            ...
            .setFooter('AOT ROLEPLAY • Hoşgeldin System • Shymoix')
    ...
    if(!kanal){
        const embed2 = new Discord.MessageEmbed()
            .setColor('#fffa00')
            .setTitle('**HATA**')
            .setDescription('**Hoşgeldin kanalını ayarlamam için bir kanal etiketlemeniz gerekli!**')
            .setThumbnail('https://cdn.discordapp.com/attachments/725820682835066914/832327684544790528/pp5.gif')
            .setFooter('AOT ROLEPLAY • Hoşgeldin System • Shymoix')
        ...
        await db.set(`hgknl_${message.guild.id}`, kanal.id);
        const embed3 = new Discord.MessageEmbed()
        .setColor('#66ff00')
        .setTitle('**HOSGELDIN LOG KANALI AYARLANDI!**')
        .setThumbnail('https://cdn.discordapp.com/attachments/725820682835066914/832327684544790528/pp5.gif')
